...
const RegisterPage = () => {
  const [formData, setFormData] = useState<Partial<User>>({ name: '', email: '', password: '', role: 'employee' });
  ...
  return (
    <div className="relative flex items-center justify-center h-screen bg-gradient-to-br from-[#1e3c72] via-[#2a5298] to-[#6dd5ed] text-white px-6">
      ...
      >
        <h2 className="text-4xl font-extrabold text-center mb-6 text-yellow-300 drop-shadow-md">🚀 Join Us</h2>
        <p className="text-center text-gray-200 mb-6">Register to create your account</p>
